...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function generateReportHTML(country, latest, bench) {
    ...
    const kpiMap = [
      ...
      { key: "% of users at Ads 10", name: "Ads at 10", type: "ad" },
      { key: "% of users at Ads 20", name: "Ads at 20", type: "ad" },
      { key: "% of users at Ads 40", name: "Ads at 40", type: "ad" },
      { key: "% of users at Ads 70", name: "Ads at 70", type: "ad" },
      { key: "% of users at Ads 100", name: "Ads at 100", type: "ad" },
    ];
